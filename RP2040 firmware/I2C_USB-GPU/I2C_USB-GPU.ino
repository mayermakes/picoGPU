...
void setup() {
Serial.begin(115200); //USB input 
Wire.begin(ID); //change pins if needed
Wire.onReceive(I2CreceiveEvent);

display.begin();
display.fillScreen(random(0x0000,0xFFFF));
display.setTextColor(0xFFFF);//set color of text
...
display.println(MSG); //print the text to the screen
//display.fillScreen(random(0x0000,0xFFFF));
}
}
